...
# hashset + minheap approach
# minheap for keeping track of the smallest number
class SmallestInfiniteSet:

    def __init__(self):
        self.is_present: {int} = set()  # hashset
        self.added_integers: [int] = [] # python minheap will be applied on it
